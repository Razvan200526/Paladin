...
export const CreativeTemplate = ({ data, config }: CreativeTemplateProps) => {
    ...
    >
      ...
      {hasContact && (
        <header
          ...
          style={{
            background: `linear-gradient(135deg, ${colors.headerBackground} 0%, ${colors.secondary} 100%)`,
            color: 'white',
          }}
        >
          {contact.fullName && (
          ...
          <div
            ...
            style={{ ...smallTextStyle, color: 'rgba(255, 255, 255, 0.9)' }}
          >
            {contact.email && (
      ...
      <div className="px-8 py-8 space-y-8">
        ...
        {hasSummary && (
          <section>
            ...
            <HtmlContent
              html={summary || ''}
              className="resume-content-creative"
              style={bodyTextStyle}
            />
          </section>
        )}
              ...
              {education.map((edu) => (
                ...
                >
                  ...
                  <HtmlContent
                    ...
                    className="resume-content-creative mt-2"
                    style={bodyTextStyle}
                  />
                </div>
              ))}
      ...
      <style>{`
        .resume-content-creative ul {
          list-style-type: none;
          padding-left: 0;
          margin-top: 0.5rem;
        }
        .resume-content-creative ol {
          list-style-type: decimal;
          padding-left: 1.25rem;
          margin-top: 0.5rem;
        }
        .resume-content-creative li {
          margin-bottom: 0.375rem;
          position: relative;
          padding-left: 1.25rem;
        }
        .resume-content-creative li::before {
          content: "→";
          position: absolute;
          left: 0;
          color: ${colors.accent};
        ...
        .resume-content-creative p {
          margin-bottom: 0.25rem;
        }
        .resume-content-creative strong {
          font-weight: 600;
          color: ${colors.text};
        }
        .resume-content-creative em {
          font-style: italic;
        }
        .resume-content-creative u {
          text-decoration: underline;
        }
        .resume-content-creative a {
          color: ${colors.accent};
          text-decoration: underline;
        }
      `}</style>
